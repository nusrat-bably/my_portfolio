  ...
  return (
    <section id="projects" className="bg-[#050505] pt-12 pb-16 relative overflow-hidden font-sans">
      ...
      <div className="container-max mx-auto max-w-7xl px-4 sm:px-6 md:px-8 relative z-10">
        ...
        {/* OVERLAPPING GRID PROJECT LIST - Forced desktop layout consistency on mobile (no vertical image-on-top collapse) */}
        <motion.div
          variants={containerVariants}
          initial="hidden"
          whileInView="visible"
          ...
          {projects.map((project, idx) => {
            ...
            return (
              ...
              >
                ...
                {/* ─── IMAGE CONTAINER WITH MAGNIFYING HOVER ─── */}
                <div 
                ...
                >
                  <a 
                    ...
                    className="block relative aspect-[16/10] rounded-md overflow-hidden bg-[#0f1110] shadow-lg group-hover:shadow-2xl z-10 transition-shadow duration-300"
                  >
                ...
                >
                  ...
                  {/* Project Title */}
                  <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-slate-200 mb-4 sm:mb-6 pointer-events-auto">
                    <a href={project.link} target="_blank" rel="noopener noreferrer" className="hover:text-teal-400 transition-colors">
                      {project.title}
                    </a>
                  </h3>
