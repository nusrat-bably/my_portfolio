...
export default function CatCompanion() {
  ...
  // Default to connect open
  const [expandedSection, setExpandedSection] = useState<'connect' | null>('connect');
  ...
  return (
    <div className="fixed bottom-10 right-10 lg:bottom-12 lg:right-12 z-50 flex flex-col items-end pointer-events-none">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="mb-6">
                ...
                <p className="mt-1 text-[13px] font-medium text-[#777777]">
                  {isSleeping 
                    ...
                    : "Systems are online! Chat with my digital twin or connect directly below."}
                </p>
              </div>
              ...
              <div className="flex flex-col space-y-2">
                ...
                {/* --- NODE 1: ASK AI ASSISTANT --- */}
                <div className="relative">
                  <button 
                    onClick={() => {
                      document.dispatchEvent(new CustomEvent('open-portfolio-chat'));
                      setIsOpen(false);
                    }}
                  ...
                  >
                    <div className="flex h-8 w-8 items-center justify-center">
                      <svg className="h-4 w-4 transition-all duration-300 text-white/20 group-hover:scale-110 group-hover:text-teal-400 group-hover:drop-shadow-[0_0_8px_rgba(45,212,191,0.6)]" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <span className="text-sm font-bold tracking-wide transition-colors text-[#a0a0a0] group-hover:text-white">
                      Ask AI Assistant
                    </span>
                  </button>
                </div>
                    ...
                    {expandedSection === 'connect' && (
                      <motion.div variants={containerVariants} initial="hidden" animate="show" exit="exit" className="overflow-hidden pl-11 pr-2">
                        <div className="flex flex-col gap-3 pb-3 pt-2">
                          ...
                          {/* Row 1: GitHub, LinkedIn, Facebook */}
                          <div className="flex gap-2">
                            <motion.a variants={itemVariants} href="https://github.com/nusrat-bably" target="_blank" rel="noopener noreferrer" className="flex h-12 flex-1 items-center justify-center rounded-xl border border-white/40 bg-white/5 text-[#e5e5e5] transition-all duration-300 hover:scale-105 hover:bg-white/15 hover:shadow-[0_0_15px_rgba(255,255,255,0.2)]">
                            ...
                            <motion.a variants={itemVariants} href="https://www.linkedin.com/in/nusrat-jahan-bably" target="_blank" rel="noopener noreferrer" className="flex h-12 flex-1 items-center justify-center rounded-xl border border-[#0077b5]/50 bg-[#0077b5]/10 text-[#0077b5] transition-all duration-300 hover:scale-105 hover:bg-[#0077b5]/20 hover:shadow-[0_0_15px_rgba(0,119,181,0.3)]">
                              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                            </motion.a>
                            <motion.a variants={itemVariants} href="https://www.facebook.com/share/1SNRJvSv3V/" target="_blank" rel="noopener noreferrer" className="flex h-12 flex-1 items-center justify-center rounded-xl border border-[#1877F2]/50 bg-[#1877F2]/10 text-[#1877F2] transition-all duration-300 hover:scale-105 hover:bg-[#1877F2]/20 hover:shadow-[0_0_15px_rgba(24,119,242,0.3)]">
                          ...
                          {/* Row 2: WhatsApp, Email & Mobile */}
                          <div className="flex gap-2">
                            <motion.a variants={itemVariants} href="https://wa.me/8801828624088" target="_blank" rel="noopener noreferrer" className="flex h-14 flex-1 items-center justify-center rounded-xl border border-[#25D366]/40 bg-[#25D366]/10 text-[#25D366] transition-all duration-300 hover:scale-105 hover:bg-[#25D366]/20 hover:shadow-[0_0_15px_rgba(37,211,102,0.3)]">
                            ...
                            <motion.a variants={itemVariants} href="https://mail.google.com/mail/?view=cm&fs=1&to=nbably4088@gmail.com" target="_blank" rel="noopener noreferrer" className="flex h-14 flex-1 items-center justify-center rounded-xl border border-teal-400/40 bg-teal-400/10 text-teal-400 transition-all duration-300 hover:scale-105 hover:bg-teal-400/20 hover:shadow-[0_0_15px_rgba(45,212,191,0.3)]">
                            ...
                            <motion.a variants={itemVariants} href="tel:+8801828624088" className="flex h-14 flex-1 items-center justify-center rounded-xl border border-[#3b82f6]/40 bg-[#3b82f6]/10 text-[#3b82f6] transition-all duration-300 hover:scale-105 hover:bg-[#3b82f6]/20 hover:shadow-[0_0_15px_rgba(59,130,246,0.3)]">
      ...
      <motion.div
        onClick={() => {
          setIsOpen(!isOpen);
          if (isOpen) setTimeout(() => setExpandedSection('connect'), 300); 
        }}
